...
//            Vector3 rotationB = RotateLoopRotationB(animation, startValue);
        ...
        public static Vector3 GetAnimationMoveFrom222(RectTransform target, UIAnimation animation, Vector3 startValue)
        {
            // ReSharper disable once SwitchStatementMissingSomeCases
            switch (animation.AnimationType)
            {
                case AnimationType.Show: return startValue;
                case AnimationType.Hide: return startValue;
                default: return DEFAULT_START_POSITION;
            }
        }
        ...
        public static Vector3 GetAnimationMoveTo222(RectTransform target, UIAnimation animation, Vector3 startValue)
        {
            // ReSharper disable once SwitchStatementMissingSomeCases
            switch (animation.AnimationType)
            {
